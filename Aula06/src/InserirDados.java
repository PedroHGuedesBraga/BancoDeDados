...
public class InserirDados extends JFrame {
    ...
    public InserirDados() throws SQLException{
        ...
        try{
            ...
            st.executeUpdate ("INSERT INTO tabela2 values(1,'Arroz');");
            st.executeUpdate ("INSERT INTO tabela2 values(2,'Feijao');");
            st.executeUpdate ("INSERT INTO tabela2 values(3,'Macarrão');");
        }catch(SQLException eSQL){
